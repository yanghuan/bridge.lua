...
namespace Bridge.Translator.Lua
{
    public class EmitBlock : AbstractEmitterBlock
    {
        ...
        protected virtual StringBuilder GetOutputForType(ITypeInfo typeInfo)
        {
            ...
            if (!fileName.ToLower().EndsWith("." + Bridge.Translator.AssemblyInfo.LUA_EXTENSION))
            {
                fileName += "." + Bridge.Translator.AssemblyInfo.LUA_EXTENSION;
            }
            ...
            if(this.Emitter.AssemblyInfo.CutScripts) {
                fileName = typeInfo.Key;
            }
        ...
        protected override void DoEmit()
        {
            ...
            foreach(var type in this.Emitter.Types) {
                ...
                string[] usings = TransformCtx.CurUsingNamespaces.ToArray();
                TransformCtx.CurUsingNamespaces.Clear();
                this.Emitter.Translator.Plugins.AfterTypeEmit(this.Emitter, type);
        ...
        public static readonly Dictionary<ITypeInfo, string[]> UsingNamespaces = new Dictionary<ITypeInfo, string[]>();
    }
}
