...
namespace Bridge.Translator.Lua
{
    public class UnaryOperatorBlock : ConversionBlock
    {
        ...
        private bool IsSingleExpression {
            get {
                return this.UnaryOperatorExpression.IsSingleExpression();
            }
        }

        private void VisitorIncOrDec(bool isInc) {
            char ch = isInc ? '+' : '-';
        ...
        private void VisitorPostIncOrDec(bool isInc) {
        ...
        protected void VisitUnaryOperatorExpression()
        {
            ...
            if (memberArgResolverResult != null && (memberArgResolverResult.Member is IProperty && !Helpers.IsFieldProperty(memberArgResolverResult.Member, this.Emitter)))
            {
                isAccessor = true;
            }
                ...
                switch (op)
                {
                    case UnaryOperatorType.BitNot:
                        ...
                        else
                        {
                            ...
                            this.Write(LuaHelper.Root, ".bnot(");
                            unaryOperatorExpression.Expression.AcceptVisitor(this.Emitter);
                            this.Write(")");
                        }
                        break;
